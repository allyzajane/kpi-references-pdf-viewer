    ...
    <header className="continuous-reader-header shrink-0 border-b border-stone-300/80 bg-[#f8f7f3] px-3 py-3 sm:px-5 sm:py-4">
      <div className="continuous-reader-heading flex min-w-0 flex-col gap-3 2xl:flex-row 2xl:items-center 2xl:justify-between">
        ...
        <div className="continuous-reader-controls flex flex-wrap items-center gap-1 2xl:justify-end">
          ...
          <Button variant="ghost" className={cn("h-10 gap-1.5 rounded-xl px-2.5 text-stone-700 hover:bg-stone-200", searchOpen && "bg-stone-200 text-stone-950")} onClick={() => setSearchOpen(value => !value)} aria-label={searchOpen ? "Close document search" : "Search document text"} title="Search document text"><Search className="size-4" /><span className="text-xs font-semibold">Find</span></Button>
