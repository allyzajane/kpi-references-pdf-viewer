...
export default function DriveSetup() {
  ...
  async function checkConnection(event: FormEvent<HTMLFormElement>) {
    ...
    if (!accessToken) { setError("Enter the operator access token to check this server-side configuration."); return; }
    setIsChecking(true);
    setError(null);
